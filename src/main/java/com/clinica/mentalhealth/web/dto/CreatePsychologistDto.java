...
public record CreatePsychologistDto(
    @Schema(description = "Nombre completo del psicólogo", example = "Dr. Gregory House")
    ...
    @Schema(description = "Nombre de usuario para login", example = "house")
    @NotBlank(message = "El nombre de usuario es requerido")
    @Size(min = 3, max = 50, message = "El usuario debe tener entre 3 y 50 caracteres")
    String username,

    @Schema(description = "Contraseña para login", example = "vicodin123")

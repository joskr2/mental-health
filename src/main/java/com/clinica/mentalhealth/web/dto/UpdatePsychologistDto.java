...
public record UpdatePsychologistDto(
        @Schema(description = "Nombre completo del psicólogo", example = "Dr. Gregory House M.D.") @Size(min = 2, max = 255, message = "El nombre debe tener entre 2 y 255 caracteres") String name,

        @Schema(description = "Especialidad médica", example = "Diagnóstico Diferencial") @Size(max = 255, message = "La especialidad no puede exceder 255 caracteres") String specialty,
        ...
        @Schema(description = "DNI del psicólogo", example = "87654321") @Pattern(regexp = "^\\d{8}$", message = "El DNI debe tener exactamente 8 dígitos") String dni) {
}
